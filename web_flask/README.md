...
This project intoduces the flask web framework focusing on the following concepts:
...
To evaluate understanding of these concepts the following taskes were given:
